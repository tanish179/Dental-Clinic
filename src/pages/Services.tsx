        ...
        <div className="grid grid-cols-12 gap-12 max-w-[1440px] mx-auto items-center">
          <div className="col-span-12 lg:col-span-7 text-center lg:text-left order-2 lg:order-1">
            ...
            <BlurText
              ...
              animateBy="words"
              direction="top"
              className="font-manrope text-[32px] md:text-[64px] lg:text-[80px] font-semibold text-navy-slate leading-[1.1] tracking-[-0.04em] mb-8 justify-center lg:justify-start"
            />
